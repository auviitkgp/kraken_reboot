...
int main(int argc,char** argv)
{
    ...
    ros::Subscriber _sub6 = n.subscribe<kraken_msgs::thrusterData6Thruster>(topics::CONTROL_PID_THRUSTER6,10,thruster6callback);
    ros::Publisher _pub = n.advertise<kraken_msgs::thrusterCmd>(topics::CONTROL_SEABOTIX,10);
